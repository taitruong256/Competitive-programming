...
g++ brute_solution.cpp -o brute_solution.exe  # nho doi ten file .cpp, dat ten file output la correct_output.txt 
g++ solution.cpp -o solution.exe              # nho doi ten file .cpp 
